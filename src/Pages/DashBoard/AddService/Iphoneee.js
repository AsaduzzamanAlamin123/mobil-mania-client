  ...
  // event.target.reset()
    ...
    return (
        ...
        <div class="card-body">
         ...
         <form onSubmit={handleIphoneUser} className='mt-1/2 grid grid-cols-4 gap-5'>
         <div>
...
<input type="text" name='k3.5mmJack' placeholder="k3.5mm Jack" class="input input-bordered input-error w-full mx-auto mb-5" />
