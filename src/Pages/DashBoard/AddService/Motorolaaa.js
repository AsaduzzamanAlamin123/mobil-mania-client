...
const Motorolaaa = () => {
    return (
       ...
       <figure><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRMncdL7QZn_rRbkNZr2xXegviaCLkiyk68Q&usqp=CAU" alt="Shoes" /></figure>
       <div class="card-body">
         <h2 class="card-title">Add Samsung Data</h2>
        <form className='mt-1/2 grid grid-cols-4 gap-5'>
        <div>
