  ...
  event.target.reset()
    ...
    return (
       <div className='mb-20 mt-96'>
        ...
        <figure><img src="https://www.androidauthority.com/wp-content/uploads/2018/08/Samsung-Galaxy-Note-9-Hands-On-17.jpg" alt="Shoes" /></figure>
        <div class="card-body">
          <h2 class="card-title">Add Samsung Data</h2>
         <form onSubmit={handleSamsungUser} className='mt-1/2 grid grid-cols-4 gap-5'>
         <div>
         ...
         <input type="text" name='USBTypeC' placeholder="USBType-C" class="input input-bordered input-error w-full mx-auto mb-5" />
         </div>
       <div>
...
<input type="text" name='MicroSDSlot' placeholder="MicroSD Slot" class="input input-bordered input-error w-full mx-auto mb-5" />
<input type="text" name='k35mmJack' placeholder="3.5mm Jack" class="input input-bordered input-error w-full mx-auto mb-5" />
