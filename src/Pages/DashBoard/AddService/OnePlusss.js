...
fetch('http://localhost:5000/oneplus', {
  ...
  .then(data => {
    ...
    return (
       ...
       <figure><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwC3WM3m6USfqqzEqKEJPCG019zFm5yTOq6w&usqp=CAU" alt="Shoes" /></figure>
       <div class="card-body">
         <h2 class="card-title">Add Samsung Data</h2>
        <form onSubmit={handleOnePlusUser} className='mt-1/2 grid grid-cols-4 gap-5'>
        <div>
...
<input type="text" name='Featurees' placeholder="Featurees" class="input input-bordered input-error w-full mx-auto mb-5" />
      ...
      <button className='btn w-full btn-outline text-blue-600 font-bold font-mono'>Add One Plus Data in Database</button>
